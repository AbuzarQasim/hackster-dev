    ...
    <div class="media">
        ...
        @if(count($comment->replies)>0)
            ...
            <div class="media" style="padding-top: 15px">
                ...
                <div class="media-body">
                    <h4 class="media-heading" style="padding-bottom: 15px">{{$reply->author}}
        ...
        <div class="comment-reply-container">
            <button class="toggle-reply btn btn-primary pull-right" style="margin-bottom: 10px">Reply</button>

                <div class="comment-reply col-sm-11" style="padding-top: 15px">
